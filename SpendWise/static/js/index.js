            ...
            wallet.id
                                                ...
                                                <div class="info">
                                                    <p class="budget">
                                                        ...
                                                        <span><i class="fa-solid fa-naira-sign"></i>${parseFloat(
                                                          wallet.budget
                                                        )}</span>    
                                                    </p>
                                                    <p class="tot-bal">
                                    ...
                                    <div class="finance-progress">
                                        ...
                                        <div class="budget-spent">
                                            ...
                                            <div class="left-budget">
                                                <p class="limit"><span><i class="fa-solid fa-naira-sign"></i></span>${
                                                  data.budget -
                                                  data.total_expense
                                                }</p>
...
function moveActiveUp() {
  const currentActiveIndex = Array.from(listItems).findIndex((li) =>
